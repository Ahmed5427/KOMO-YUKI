export default function Hero() {
  return (
    <section className="relative h-[90vh] md:h-[75vh] min-h-[500px] md:min-h-[600px] max-h-[750px] flex items-end pb-12 md:pb-16 pt-22 md:pt-26">
      {/* Background Image - Mobile */}
      <div
        className="absolute inset-x-0 top-22 md:top-26 bottom-0 bg-cover bg-center bg-no-repeat md:hidden"
        style={{
      ...
      <div
        className="hidden md:block absolute inset-x-0 top-22 md:top-26 bottom-0 bg-cover bg-no-repeat"
        style={{
